#
#  Be sure to run `pod spec lint Waterpurifier.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "云米科技"
  # s.authors            = { "云米科技" => "chenyang@viomi.com.cn" }
  # s.social_media_url   = "http://twitter.com/云米科技"
